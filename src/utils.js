...
export function loadData() {
  try {
    ...
    // Fallback: defaultData zurückgeben
    return defaultData();
...
export const C = {
  ...
  // Semantic (references CSS variables for light/dark mode)
  bg: 'var(--color-bg)',
  ...
  sf2: 'var(--color-surface-secondary)',
  tx: 'var(--color-text-primary)',
  mu: 'var(--color-text-secondary)',
  br: 'var(--color-text-primary)',
  ac: '#0071E3',
  acd: 'rgba(0, 113, 227, 0.15)',
  cr: '#FF3B30',
  crd: 'rgba(255, 59, 48, 0.15)',
  gr: '#34C759',
  yw: '#FF9500',
  ywd: 'rgba(255, 149, 0, 0.15)',
...
export const T = {
  h1: { fontSize: '32px', fontWeight: 700, lineHeight: 1.2, letterSpacing: '-0.5px' },
  h2: { fontSize: '24px', fontWeight: 600, lineHeight: 1.3, letterSpacing: '-0.3px' },
  h3: { fontSize: '18px', fontWeight: 600, lineHeight: 1.4 },
  bodyLarge: { fontSize: '16px', fontWeight: 400, lineHeight: 1.5 },
  bodyLargeMedium: { fontSize: '16px', fontWeight: 500, lineHeight: 1.5 },
  ...
  mono: { fontSize: '13px', fontWeight: 400, lineHeight: 1.5, fontFamily: C.mono },
};
...
export const Tr = {
  quick: '0.1s cubic-bezier(0.4, 0, 0.2, 1)',
  normal: '0.15s cubic-bezier(0.4, 0, 0.2, 1)',
  slow: '0.2s cubic-bezier(0.4, 0, 0.2, 1)',
};

export const ST = {
  green:  { c: C.success, label: 'In Ordnung',     bg: 'rgba(52, 199, 89, 0.1)'  },
  yellow: { c: C.warning, label: 'In Bearbeitung',  bg: 'rgba(255, 149, 0, 0.1)' },
  red:    { c: C.critical, label: 'Problem',         bg: 'rgba(255, 59, 48, 0.1)'    },
};
