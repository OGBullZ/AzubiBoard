...
type LearnWidgetProps = {
  userId?: string | number;
  onNavigate: () => void;
};

function LearnWidgetImpl({ userId, onNavigate }: LearnWidgetProps) {
    ...
    <div>
      ...
      {last && (
        <div style={{ marginBottom: 9 }}>
          ...
          <ProgressBar value={last.pct} color={last.pct >= 75 ? C.gr : last.pct >= 50 ? C.yw : C.cr} height={6} label={`${last.pct}%`} />
