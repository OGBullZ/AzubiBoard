  ...
  return (
    <div
      ...
      <div
        ...
        style={{ background: C.sf, border: `1px solid ${C.bd2}`, borderRadius: 12, padding: 24, width: 340, maxWidth: '90vw', boxShadow: '0 16px 60px rgba(0,0,0,.6)', animation: 'fadeUp .15s ease', outline: 'none' }}
